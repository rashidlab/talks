...
**You're combining into a toxicity budget that's already nearly spent.** 48% of monotherapy patients already require dose modification at 300 mg. A combination doesn't just add toxicity — it adds **overlapping, non-additive** toxicity that single-agent data can't predict.
:::
...
- **Why 3+3 doesn't fit combinations.** Built for single-agent cytotoxics [@letourneau2009], it assumes monotonic dose-toxicity, Cycle-1-observable DLTs, and a single dose dimension — combinations strain all three.
...
::: {.fragment style="margin-top: 0.4em; padding: 0.55em 1em; background-color: #13294B; color: #FFFFFF; text-align: center; font-size: 1.05em; font-weight: 700;"}
