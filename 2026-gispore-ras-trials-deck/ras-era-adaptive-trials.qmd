...
::: {.column width="50%"}
![](images/ras-rtk-feedback.svg){width=100% fig-align="center" fig-alt="Schematic: daraxonrasib drives RTK pathway activation on PDAC cells through cell-surface expression upregulation and recurrent genomic alterations, a compensatory feedback that is both a resistance mechanism and a combination target"}
:::
