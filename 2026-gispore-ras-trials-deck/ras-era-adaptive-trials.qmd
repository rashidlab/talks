...
::: {.column width="58%"}
::: {.fragment style="margin-top: 0.6em; font-size: 0.92em; line-height: 1.5;"}
- **No closed-form for adaptive designs.** Unlike Simon two-stage — where Type I, power, and N come from a formula — adaptive Bayesian designs need *thousands of simulated trials per candidate*: pick parameters (efficacy thresholds, max N, cohort size, H₀ / H₁ assumptions), simulate, read off OCs. **Comparing candidates means simulating each.**
