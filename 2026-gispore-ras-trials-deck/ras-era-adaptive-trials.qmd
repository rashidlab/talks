...
- **3+3 was built for single-agent cytotoxics** [@letourneau2009] — assuming monotonic dose-toxicity, Cycle-1-observable DLTs, and a single dose dimension. **Combinations break all three, and 3+3 has no joint-surface model at all.**
