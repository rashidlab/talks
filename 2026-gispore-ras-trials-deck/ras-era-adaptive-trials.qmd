...
::: {.column width="60%"}
![](images/baseline_static.jpg){width=100% fig-alt="Real patient trajectory from Coombes 2019: ctDNA variant allele frequency rises starting day 470 and climbs two orders of magnitude by day 1246, while CA 15-3 stays at baseline until day 1078. Annotated lead time: 611 days between molecular signal and clinical detection."}

::: {style="margin-top: 0.3em; font-size: 0.7em; color: #5B6670; font-style: italic;"}
Coombes et al., *Clin Cancer Res* 2019 [@coombes2019ctdna] — personalized ctDNA detected metastatic relapse a median **8.9 months ahead of clinical/radiologic detection** across 49 adjuvant breast cancer patients; this HR+ case (E026) shows a 611-day lead time. Same structural principle applies to active-therapy resistance — see notes.
:::
:::
...
- Resistance is characterized retrospectively — only after progression and closure [@awad2021resistance; @aguirre2024resistance]
- The temporal surface (when resistance emerges, in which patients) is never characterized

::: {.fragment style="margin-top: 0.5em; padding: 0.5em 0.7em; background-color: #F8F9FA; border-left: 3px solid #4B9CD3; font-size: 0.82em; color: #13294B;"}
**Genomic → ctDNA · non-genomic → biopsies, transcriptomics, imaging — *do both* during enrollment.** Same structural failure as combination dose-finding: static designs for a dynamic problem.
:::
:::
:::
...
::: {.slide-refs}
Coombes et al., *Clin Cancer Res* 2019 · Awad et al., *NEJM* 2021 · Aguirre et al., *Cancer Discov* 2024 (both post-progression analyses)
:::
...
- **Different disease, same design problem:** longitudinal resistance detection + biomarker-guided adaptation. The four axes are disease-agnostic; a RAS-backbone PDAC combination would need all four for the same reasons.

:::: {.columns}

::: {.column width="55%"}
![](images/adapt_goal_dynamic.jpg){width=100% fig-alt="Two-panel ARPA-H ADAPT schematic. Top current state: single static biomarker, sequential treatments, resistant subclones persist. Bottom ADAPT future state: in-depth dynamic biomarkers, treatments switched in response, mixed final population converging on clearance."}

::: {style="margin-top: 0.25em; font-size: 0.65em; color: #5B6670; font-style: italic; text-align: center;"}
ARPA-H ADAPT program overview — current static-biomarker state (top) vs dynamic-biomarker state ADAPT enables (bottom).
:::
:::

::: {.column width="45%"}
::: {.fragment style="font-size: 0.74em;"}
