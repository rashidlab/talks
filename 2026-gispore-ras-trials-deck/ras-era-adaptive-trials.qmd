...
- **Combinations break all three** — and 3+3 has no joint-surface model at all.
- **In practice:** pick A's dose, fix it, add B — the dominant pattern. Rivière's review of 162 combination trials: **88% used single-agent designs** even when both drugs were escalated [@riviere2015combo; @harrington2013dual].
