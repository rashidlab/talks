...
ggplot() +
  ...
  geom_text(aes(x = -0.25, y = 2.2), label = "Traditional",
            color = "#5B6670", size = 4.5, fontface = "bold", hjust = 0) +
  geom_text(aes(x = -0.25, y = 0.8), label = "Adaptive",
  ...
  scale_x_continuous(limits = c(-0.4, 8.2), expand = c(0, 0)) +
...
::: {style="margin-top: 0.3em; text-align: center; font-size: 1.05em; color: #13294B; font-weight: 700;"}
Different disease, same design problem.
:::

::: {style="margin-top: 0.3em; font-size: 0.92em; line-height: 1.4;"}
- Longitudinal resistance detection
- Biomarker-guided adaptation
- Template ports directly to PDAC (next slide)
:::

![](images/adapt_goal_dynamic.jpg){width=80% fig-align="center" fig-alt="Two-panel ARPA-H ADAPT schematic: current static-biomarker state (top) vs dynamic-biomarker state (bottom)."}

::: {.fragment style="margin-top: 0.3em; text-align: center; font-size: 0.82em; color: #13294B; font-style: italic;"}
