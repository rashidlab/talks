...
Red = high expected N (bad); blue = low. Dashed lines = Type I and Power constraints. Numbered points = sequential evaluations converging to the constrained optimum (★).
:::
:::
:::
