...
::: {.fragment style="margin-top: 0.3em; padding: 0.6em 1em; background-color: #F8F9FA; border-left: 4px solid #4B9CD3; color: #13294B; font-size: 0.9em; text-align: center;"}
A resistance-aware trial has to **do both** during enrollment [@awad2021resistance; @aguirre2024resistance].
:::
...
<span style="color: #FFFFFF;">Methods are ready.</span> <strong style="color: #FFFFFF;">We're operationalizing them in PDAC trials — starting with PANGEA.</strong>
</div>
:::
...
::: {style="margin-top: 0.5em; font-size: 0.78em; color: #13294B; font-style: italic; text-align: center;"}
...
We needed a faster way to calibrate the trial."
:::
...
::: {.fragment style="margin-top: 0.5em; text-align: center; font-size: 0.92em; color: #13294B; font-weight: 600;"}
**Far fewer evaluations than grid search** — finds feasible designs that grid search often misses entirely. For a 4-parameter design like this one: manual calibration takes days, BATON takes minutes, with a regulatory-ready audit trail.
:::
...
::: {style="margin-top: 0.3em; font-size: 0.72em; color: #5B6670; font-style: italic; text-align: center;"}
H₀ = drug inactive (no PFS benefit over GnP alone)  ·  H₁ = drug active at the assumed effect size (HR 0.58)
:::

::: {style="margin-top: 0.3em; font-size: 0.78em; color: #13294B; font-style: italic; text-align: center;"}
