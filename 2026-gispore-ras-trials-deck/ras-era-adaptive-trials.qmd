...
![](images/ras-rtk-feedback.svg){width=82% fig-align="center" fig-alt="Schematic: daraxonrasib drives RTK upregulation on PDAC cell surface, a compensatory feedback that is both a resistance mechanism and a combination target"}

:::: {.columns}

::: {.column width="55%"}
::: {style="font-size: 0.92em; line-height: 1.45;"}
...
::: {.column width="45%"}
::: {style="font-size: 0.92em; line-height: 1.45;"}
**1L combination cohort** (daraxonrasib **200 mg** + GnP, n=40) [@rmcgi102]: ORR **58%** · DCR **90%** · 6-mo PFS **84%** · 6-mo OS **90%**.
:::
:::
