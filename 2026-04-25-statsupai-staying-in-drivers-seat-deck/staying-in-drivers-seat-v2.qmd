...
Distributing practice over time, not cramming. AI's instant access collapses spacing into a single retrieval.
:::
::: {.quadrant}
[Interleaving]{.quadrant-title}

Mixing topics, not blocked practice. AI's task-specific scaffolding tends to reinforce blocking.
:::
::: {.quadrant}
[Retrieval practice]{.quadrant-title}

Testing as study, not just review. When AI supplies the answer, the retrieval that builds memory doesn't happen.
:::
::: {.quadrant}
[Generation]{.quadrant-title}

Producing answers, not reading them. Generation is where AI most directly substitutes for the learner.
:::
:::
