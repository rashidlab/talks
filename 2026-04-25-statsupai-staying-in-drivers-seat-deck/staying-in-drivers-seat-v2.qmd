...
Bainbridge's *Ironies of Automation* (1983) named four specific failure modes that map directly to AI use today.

<div class="quadrant-grid">
<div class="quadrant">
<div class="quadrant-title">1. Skill degradation in the takeover</div>
<div class="quadrant-detail">The better the automation, the rarer the cases that need a human — and the less practiced the human is when those cases arrive.</div>
</div>
<div class="quadrant">
<div class="quadrant-title">2. The training paradox</div>
<div class="quadrant-detail">We train people to follow instructions, then put them in the loop to provide judgment. The two skills aren't the same.</div>
</div>
<div class="quadrant">
<div class="quadrant-title">3. The monitoring difficulty</div>
<div class="quadrant-detail">Sustained attention is what humans are worst at — and it becomes their primary job once automation handles the routine work.</div>
</div>
<div class="quadrant">
<div class="quadrant-title">4. The transparency cost</div>
<div class="quadrant-detail">For humans to oversee, the system must operate in ways humans can follow — even when that's technically suboptimal.</div>
</div>
</div>
...
<div class="flow-step">Frame the<br>question</div>
<div class="flow-arrow">→</div>
<div class="flow-step">Choose<br>methods</div>
<div class="flow-arrow">→</div>
<div class="flow-step">Verify<br>output</div>
<div class="flow-arrow">→</div>
<div class="flow-step">Interpret<br>result</div>
<div class="flow-arrow">→</div>
<div class="flow-step">Defend<br>the work</div>
</div>
...
::: {.fragment style="margin-top: 0.8em; font-size: 0.92em;"}
...
## What the struggle preserves {.smaller}

Bjork & Bjork identified four *desirable difficulties* — specific kinds of effort that distinguish learning that lasts from performance that fades.

<div class="quadrant-grid">
<div class="quadrant">
<div class="quadrant-title">Spacing</div>
<div class="quadrant-detail">Distributing practice over time, not cramming. AI's instant access collapses spacing into a single retrieval.</div>
</div>
<div class="quadrant">
<div class="quadrant-title">Interleaving</div>
<div class="quadrant-detail">Mixing topics, not blocked practice. AI's task-specific scaffolding tends to reinforce blocking.</div>
</div>
<div class="quadrant">
<div class="quadrant-title">Retrieval practice</div>
<div class="quadrant-detail">Testing as study, not just review. When AI supplies the answer, the retrieval that builds memory doesn't happen.</div>
</div>
<div class="quadrant">
<div class="quadrant-title">Generation</div>
<div class="quadrant-detail">Producing answers, not reading them. Generation is where AI most directly substitutes for the learner.</div>
</div>
</div>

::: {.fragment style="margin-top: 0.7em; text-align: center; font-size: 1.0em; color: #13294B; font-weight: 600;"}
AI tends to remove all four. Each one needs deliberate preservation.
:::
...
::: {.notes}
Why does productive struggle matter mechanically? Bjork and Bjork named four specific kinds of difficulty that distinguish performance that fades from learning that lasts.

Spacing — distributing practice over time rather than cramming. The principle is that the effort of recalling something after a delay strengthens the memory more than re-reading it immediately. AI tends to collapse spacing into a single retrieval — you ask, you get the answer, you move on. The delay-and-recall cycle doesn't happen.

Interleaving — mixing topics rather than blocked practice. The effort of distinguishing similar concepts is where their differences get encoded. AI's task-specific scaffolding tends to reinforce blocking — each session focuses on one thing.
...
Generation — producing answers rather than reading them. The effort of generating is what distinguishes long-term retention from passive recognition. Generation is exactly where AI most directly substitutes for the learner.

The honest extrapolation: AI tends to remove all four, every time we use it. Each one needs deliberate preservation if we care about the learning, not just the answer.
:::
...
<div class="worked-col">
<div class="worked-label">What I wrote (1 min)</div>
<div class="worked-text">
<strong>Goal:</strong> sample size for a confirmatory follow-up.<br><br>
<strong>My approach:</strong> use the pilot's effect size in <code>pwr.t.test()</code>.<br><br>
<strong>Tricky:</strong> the pilot is small and may overestimate the effect. I want to plan for a deflated value too.
</div>
</div>
<div class="worked-col ai">
<div class="worked-label">What AI suggested</div>
<div class="worked-text">
<code>pwr.t.test()</code> with the pilot's reported effect size, 80% power, two-sided α = 0.05.<br><br>
A clean, correct answer to the literal question.
</div>
</div>
<div class="worked-col">
<div class="worked-label">What I learned</div>
<div class="worked-text">
AI answered the <em>literal</em> prompt — not the concern the third line raised.<br><br>
The diff revealed my real question: <em>what effect size do I plan for given the pilot is likely inflated?</em><br><br>
