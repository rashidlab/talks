...
**Not** that we should use AI less.
:::
...
<div style="margin: 0.7em 0 0.3em; padding: 0.7em 1em; background-color: #FCF5DC; border-left: 3px solid #D9B546; font-size: 0.68em; line-height: 1.55;">
  <div style="font-style: italic; color: #5B6670; margin-bottom: 0.35em;">Same question - heteroskedasticity and model choice:</div>
  <div style="font-family: 'IBM Plex Mono', monospace; color: #13294B;"><strong style="color: #007FAE;">Executor:</strong> "Fit OLS with HC3 robust SEs and show a feasible GLS sensitivity analysis."</div>
  <div style="font-family: 'IBM Plex Mono', monospace; color: #13294B;"><strong style="color: #007FAE;">Tutor:</strong> "Quiz me on the assumptions behind OLS+HC3, feasible GLS, and robust regression before writing code."</div>
  <div style="font-family: 'IBM Plex Mono', monospace; color: #13294B;"><strong style="color: #007FAE;">Critic:</strong> "Argue against feasible GLS here. What residual pattern or design feature would make OLS+HC3 preferable?"</div>
</div>
```
